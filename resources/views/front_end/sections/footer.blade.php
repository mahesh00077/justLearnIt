             ...
             <div class="row">
                 <div class="col-lg-4 col-md-6">
                     <div class="footer-about mt-40">
                         <div class="logo">
                             <a href="#"><img src="{{asset('frontend_assets/images/logo.png')}}" alt="Logo"></a>
                         </div>
             ...
             <div class="row">
                 <div class="col-md-8">
                     <div class="copyright text-md-left text-center pt-15">
                         <p><a target="_blank" href="#">Designed by Mahesh</a> </p>
                     </div>
                 </div>
                 <div class="col-md-4">
 ...
 <!--====== Nice Number js ======-->
 <script src="{{ asset('frontend_assets/js/jquery.nice-number.min.js')}}"></script>
