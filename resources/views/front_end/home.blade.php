            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="singel-slider-feature justify-content-center mt-30">
                        <div class="icon">
                            <img src="{{ asset('frontend_assets/images/all-icon/man.png')}}" alt="icon">
                        </div>
                        <div class="cont">
                            <h3>13,0000</h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="singel-slider-feature justify-content-center mt-30">
                        <div class="icon">
                            <img src="{{ asset('frontend_assets/images/all-icon/book.png')}}" alt="icon">
                        </div>
                        <div class="cont">
                            <h3>4,000509</h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="singel-slider-feature justify-content-center mt-30">
                        <div class="icon">
                            <img src="{{ asset('frontend_assets/images/all-icon/expert.png')}}" alt="icon">
                        </div>
                        <div class="cont">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="singel-items text-center mt-30">
                    <div class="items-image">
                        <img src="{{ asset('frontend_assets/images/category/ctg-1.jpg')}}" alt="Category">
                    </div>
        ...
        <div class="row course-slied mt-30">
            <div class="col-lg-4">
                <div class="singel-course-2">
                    <div class="thum">
                        <div class="image">
                            <img src="{{ asset('frontend_assets/images/course/cu-1.jpg')}}" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="courses-singel.html"><img
                                        src="{{ asset('frontend_assets/images/course/teacher/t-1')}}.jpg"
                                        alt="teacher"></a>
                            </div>
                            <div class="name">
                                <a href="#">
            ...
            <div class="col-lg-4">
                <div class="singel-course-2">
                    <div class="thum">
                        <div class="image">
                            <img src="{{ asset('frontend_assets/images/course/cu-2.jpg')}}" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="courses-singel.html"><img
                                        src="{{ asset('frontend_assets/images/course/teacher/t-2')}}.jpg"
                                        alt="teacher"></a>
                            </div>
                            <div class="name">
                                <a href="#">
            ...
            <div class="col-lg-4">
                <div class="singel-course-2">
                    <div class="thum">
                        <div class="image">
                            <img src="{{ asset('frontend_assets/images/course/cu-3.jpg')}}" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="courses-singel.html"><img
                                        src="{{ asset('frontend_assets/images/course/teacher/t-3')}}.jpg"
                                        alt="teacher"></a>
                            </div>
                            <div class="name">
                                <a href="#">
            ...
            <div class="col-lg-4">
                <div class="singel-course-2">
                    <div class="thum">
                        <div class="image">
                            <img src="{{ asset('frontend_assets/images/course/cu-4.jpg')}}" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="courses-singel.html"><img
                                        src="{{ asset('frontend_assets/images/course/teacher/t-4')}}.jpg"
                                        alt="teacher"></a>
                            </div>
                            <div class="name">
                                <a href="#">
            ...
            <div class="col-lg-4">
                <div class="singel-course-2">
                    <div class="thum">
                        <div class="image">
                            <img src="{{ asset('frontend_assets/images/course/cu-5.jpg')}}" alt="Course">
                        </div>
                        <div class="price">
                            <span>Free</span>
                        </div>
                        <div class="course-teacher">
                            <div class="thum">
                                <a href="courses-singel.html"><img
                                        src="{{ asset('frontend_assets/images/course/teacher/t-5')}}.jpg"
                                        alt="teacher"></a>
                            </div>
                            <div class="name">
                                <a href="#">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="teachers-2-singel mt-30">
                                <div class="thum">
                                    <img src="{{ asset('frontend_assets/images/teachers/teacher-2/tc')}}-1.jpg"
                                        alt="Teacher">
                                </div>
                                <div class="cont">
                        ...
                        <div class="col-md-6">
                            <div class="teachers-2-singel mt-30">
                                <div class="thum">
                                    <img src="{{ asset('frontend_assets/images/teachers/teacher-2/tc')}}-2.jpg"
                                        alt="Teacher">
                                </div>
                                <div class="cont">
                                    <a href="teachers-singel.html">
                ...
                <div class="happy-student mt-55">
                    ...
                    <div class="student-slied">
                        <div class="singel-student">
                            <img src="{{ asset('frontend_assets/images/teachers/teacher-2/quote')}}.png" alt="Quote">
                    ...
                    <div class="student-image">
                        <img src="{{ asset('frontend_assets/images/teachers/teacher-2/happy')}}.png" alt="Image">
                    </div>
                </div> <!-- happy student -->
            </div>
        </div> <!-- row -->
            ...
            <div class="col-lg-6">
                <div class="singel-news mt-30">
                    <div class="news-thum pb-25">
                        <img src="{{ asset('frontend_assets/images/news/n-1.jpg')}}" alt="News">
                    </div>
                    <div class="news-cont">
                        <ul>
            ...
            <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="news-thum mt-30">
                                <img src="{{ asset('frontend_assets/images/news/ns-1.jpg')}}" alt="News">
                            </div>
                        </div>
                        <div class="col-sm-8">
                ...
                <div class="singel-news news-list">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="news-thum mt-30">
                                <img src="{{ asset('frontend_assets/images/news/ns-2.jpg')}}" alt="News">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="news-cont mt-30">
                ...
                <div class="singel-news news-list">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="news-thum mt-30">
                                <img src="{{ asset('frontend_assets/images/news/ns-3.jpg')}}" alt="News">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="news-cont mt-30">
        ...
        <div class="row patnar-slied">
            <div class="col-lg-12">
                <div class="singel-patnar text-center mt-40">
                    <img src="{{ asset('frontend_assets/images/patnar-logo/p-1')}}.png" alt="Logo">
                </div>
            </div>
            <div class="col-lg-12">
                <div class="singel-patnar text-center mt-40">
                    <img src="{{ asset('frontend_assets/images/patnar-logo/p-2')}}.png" alt="Logo">
                </div>
            </div>
            <div class="col-lg-12">
                <div class="singel-patnar text-center mt-40">
                    <img src="{{ asset('frontend_assets/images/patnar-logo/p-3')}}.png" alt="Logo">
                </div>
            </div>
            <div class="col-lg-12">
                <div class="singel-patnar text-center mt-40">
                    <img src="{{ asset('frontend_assets/images/patnar-logo/p-4')}}.png" alt="Logo">
                </div>
            </div>
            <div class="col-lg-12">
                <div class="singel-patnar text-center mt-40">
